...
import React__default, { useRef, createContext, useContext, useEffect, createElement, useMemo, forwardRef, Fragment, Component as Component$1, useCallback, useState, cloneElement, Children, isValidElement, useLayoutEffect } from 'react';
...
function MotionConfig(_a) {
    ...
    var loadedFeatures = __spreadArrays(pluginContext.features, features);
...
function useMotionTemplate(fragments) {
     ...
     * schedule an update.
     */
    useValueOnChange(values, function () { return sync.update(updateValue, false, true); });
    return value;
}
